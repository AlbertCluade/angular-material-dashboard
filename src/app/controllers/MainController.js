  ...
  function MainController(navService, $mdSidenav, $mdBottomSheet, $log, $q, $state, $mdToast) {
    ...
    function showActions($event) {
        ...
        function SheetController( $mdBottomSheet ) {
          ...
          vm.actions = [
            { name: 'Share', icon: 'share', url: 'https://github.com/AlbertCluade/angular-material-dashboard.git' },
            { name: 'Star', icon: 'star', url: 'https://github.com/AlbertCluade/angular-material-dashboard.git' }
          ];
